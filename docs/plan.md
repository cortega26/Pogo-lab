...
| S8 | **Deploy en VPS Oracle Cloud Infrastructure** (ARM Ampere A1 2 OCPU / 12 GB Always Free) + Docker Compose | Elección del usuario ("Oracle Cloud") | Medio | Bajo | Decidido en ADR-0009; contenedor portable a PaaS/VPS si fuera necesario |
...
- **Hosting decidido (2026-07-17, actualizado 2026-07-23):** **Oracle Cloud Infrastructure (OCI)** en capa gratuita — ARM Ampere A1 (2 OCPU, 12 GB) + Docker Compose (ADR-0009). Una configuración de 4 OCPU / 24 GB requiere PAYG.
